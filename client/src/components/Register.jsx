...
import Image00001 from "./image/m10.jpeg";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://componentx-server.vercel.app/api/register",
        {
          method: "POST",
          headers: {
    ...
    <div className="register">
      <div className="flex justify-center items-center flex-col lg:flex-row gap-4 pb-5 md:pb-0 max-w-[1200px] mx-auto my-0 mt-10">
        ...
        >
          ...
          <div className="relative mb-6 w-full max-w-xs">
            ...
            />
            <div
              className="absolute inset-y-0 right-4 flex items-center ps-3.5 cursor-pointer"
      ...
      {submission && (
        <div className="bg-green-100 border border-green-300 rounded-lg p-4 mb-4 fixed top-0 w-full h-[100vh] text-black flex flex-col justify-center items-center space-y-4">
          <p className="text-xl font-semibold font-bebas">
            Register Successful!
          </p>
          <Link
            to="/dashboard"
